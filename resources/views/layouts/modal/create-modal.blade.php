        ...
        <form action="{{ route('home.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div>
                ...
                <div class="flex items-center justify-between bg-base-200 p-1 rounded">
                    ...
                    <input name="media" type="file" id="media" accept="image/*,video/*"
                        class="cursor-pointer block w-full text-sm text-base-content file:mr-4 file:py-2 file:px-4 file:border-0 file:border-base-300 file:text-sm file:font-semibold file:bg-base-300 file:text-base-content hover:file:bg-base-100 file:cursor-pointer file:rounded"
