<nav
    class="w-16 xl:w-64 shrink-0 bg-base-100 border-r border-gray-200 dark:border-gray-700 h-full fixed left-0 overflow-y-auto">
    <div class="px-4 py-8">
        <a href="#" class="shrink-0">
            <div class="flex items-center justify-start gap-2">
                <x-application-logo class="block h-9 w-auto fill-current base-content" />
                <span class="ml-3 hidden xl:block text-xl">LaraSync</span>
            </div>
        </a>
    </div>
    <ul class="mt-4 space-y-4">
        <li>
            {{-- <a href="#" class="flex items-center p-2 mx-2 rounded hover:bg-base-300">
    ...
    {{-- <div class="mt-auto p-4 mb-10">
        <div class="flex items-center justify-center xl:justify-start p-2 rounded hover:bg-base-300">
            <label class="form-control w-full max-w-xs mt-auto">
                <div class="label">
...
<script>
    ...
    function applyTheme(theme) {
        ...
        // Update the state of all toggle checkboxes
    ...
    document.addEventListener('DOMContentLoaded', () => {
        const savedTheme = localStorage.getItem('theme') ||
            'winter'; // Default to 'winter' if no theme is saved
